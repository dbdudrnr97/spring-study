...
<div id="demo-container" 
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="devSubmit('dev3');" class="list-group-item list-group-item-action">파라미터 핸들링 - @Command</button>
...
<script>
/**
 * Template String - `${id}` 이런식으로 해두면 변수내용 그대로 찍어줌
   jsp 사용시 escaping(\) 처리 필수
 */
